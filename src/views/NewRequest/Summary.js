            ...
            <SafeAreaView forceInset={{ top: 'never', bottom: 'never' }} style={styles.container}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={styles.mapSummary}>
                        <ImageBackground source={require('../../assets/Images/new_request_summary.png')} style={styles.mapImage}>
                    ...
                    <View style={styles.mapSummary}>
                        <ImageBackground source={require('../../assets/Images/new_request_summary.png')} style={styles.mapImage}>
                            ...
                            {!this.state.isShowSummaryView ?
                               ...
                               : <View style={{ height: hp('100%'), bottom: '0%', position: 'absolute', width: wp('100%'), backgroundColor: 'white' }}>
                                    { /* Pickup location */}
                                    <KeyboardAwareScrollView style={{ height: hp('100%'), bottom: '0%', }}>
